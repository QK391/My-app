            ...
            <div className="row">
                <div className="col-3">
                    ...
                    <div className="filter-card mb-3">
                        ...
                        <div>
                            <h5 className="sub-title">Availablyti</h5>
                            <div>
                    ...
                    <div className="filter-sort-grid mb-4">
                        <div className="d-flex justify-content-between align-items-center">
                            <div className="d-flex align-items-center gap-10">
                                ...
                                <select className="form-control form-select" defaultValue={"manula"} name="" id="">
                                    <option value="manual">Featured</option>
                                    <option value="best-selling">Best selling</option>
                                    <option value="title-asecnding">Alphabetically, A-Z</option>
                                    <option value="title-descending">Alphabetically, Z-A</option>
                                    <option value="price-asecnding">Price, low to high</option>
                                    <option value="price-descending">Price, high low to</option>
                                    <option value="created-asecnding">Date, old to new</option>
